...
import com.pmc.ccms.repository.ItemRepository;
...
class ItemResourceIT {
    ...
    private static final Boolean DEFAULT_VEG = false;
    private static final Boolean UPDATED_VEG = true;
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().name(DEFAULT_NAME).veg(DEFAULT_VEG);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().name(UPDATED_NAME).veg(UPDATED_VEG);
        return item;
    }
    ...
    void createItem() throws Exception {
        ...
        assertThat(testItem.getVeg()).isEqualTo(DEFAULT_VEG);
    }
    ...
    void getAllItems() throws Exception {
        ...
        restItemMockMvc
            ...
            .andExpect(jsonPath("$.[*].veg").value(hasItem(DEFAULT_VEG.booleanValue())));
    }
    ...
    void getItem() throws Exception {
        ...
        restItemMockMvc
            ...
            .andExpect(jsonPath("$.veg").value(DEFAULT_VEG.booleanValue()));
    }
    ...
    void putNewItem() throws Exception {
        ...
        updatedItem.name(UPDATED_NAME).veg(UPDATED_VEG);
        ...
        assertThat(testItem.getVeg()).isEqualTo(UPDATED_VEG);
    }
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.name(UPDATED_NAME).veg(UPDATED_VEG);
