...
class MenuResourceIT {
    ...
    private static final LocalDate DEFAULT_SERVE_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_SERVE_DATE = LocalDate.now(ZoneId.systemDefault());

    private static final LocalDate DEFAULT_BOOK_BEFORE_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_BOOK_BEFORE_DATE = LocalDate.now(ZoneId.systemDefault());

    private static final LocalDate DEFAULT_CANCEL_BEFORE_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_CANCEL_BEFORE_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Menu createEntity(EntityManager em) {
        Menu menu = new Menu()
            .name(DEFAULT_NAME)
            .serveDate(DEFAULT_SERVE_DATE)
            .bookBeforeDate(DEFAULT_BOOK_BEFORE_DATE)
            .cancelBeforeDate(DEFAULT_CANCEL_BEFORE_DATE);
        return menu;
    }
    ...
    public static Menu createUpdatedEntity(EntityManager em) {
        Menu menu = new Menu()
            .name(UPDATED_NAME)
            .serveDate(UPDATED_SERVE_DATE)
            .bookBeforeDate(UPDATED_BOOK_BEFORE_DATE)
            .cancelBeforeDate(UPDATED_CANCEL_BEFORE_DATE);
        return menu;
    }
    ...
    void createMenu() throws Exception {
        ...
        assertThat(testMenu.getServeDate()).isEqualTo(DEFAULT_SERVE_DATE);
        assertThat(testMenu.getBookBeforeDate()).isEqualTo(DEFAULT_BOOK_BEFORE_DATE);
        assertThat(testMenu.getCancelBeforeDate()).isEqualTo(DEFAULT_CANCEL_BEFORE_DATE);
    }
    ...
    void getAllMenus() throws Exception {
        ...
        restMenuMockMvc
            ...
            .andExpect(jsonPath("$.[*].serveDate").value(hasItem(DEFAULT_SERVE_DATE.toString())))
            .andExpect(jsonPath("$.[*].bookBeforeDate").value(hasItem(DEFAULT_BOOK_BEFORE_DATE.toString())))
            .andExpect(jsonPath("$.[*].cancelBeforeDate").value(hasItem(DEFAULT_CANCEL_BEFORE_DATE.toString())));
    }
    ...
    void getMenu() throws Exception {
        ...
        restMenuMockMvc
            ...
            .andExpect(jsonPath("$.serveDate").value(DEFAULT_SERVE_DATE.toString()))
            .andExpect(jsonPath("$.bookBeforeDate").value(DEFAULT_BOOK_BEFORE_DATE.toString()))
            .andExpect(jsonPath("$.cancelBeforeDate").value(DEFAULT_CANCEL_BEFORE_DATE.toString()));
    }
    ...
    void putNewMenu() throws Exception {
        ...
        assertThat(testMenu.getServeDate()).isEqualTo(UPDATED_SERVE_DATE);
        assertThat(testMenu.getBookBeforeDate()).isEqualTo(UPDATED_BOOK_BEFORE_DATE);
        assertThat(testMenu.getCancelBeforeDate()).isEqualTo(UPDATED_CANCEL_BEFORE_DATE);
    }
    ...
    void partialUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.cancelBeforeDate(UPDATED_CANCEL_BEFORE_DATE);
