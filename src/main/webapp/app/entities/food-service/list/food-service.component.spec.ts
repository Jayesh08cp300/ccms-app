...
describe('FoodService Management Component', () => {
  let comp: FoodServiceComponent;
  let fixture: ComponentFixture<FoodServiceComponent>;
  let service: FoodServiceService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'food-service', component: FoodServiceComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(FoodServiceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.foodServices?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
