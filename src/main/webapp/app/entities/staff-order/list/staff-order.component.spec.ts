...
describe('StaffOrder Management Component', () => {
  let comp: StaffOrderComponent;
  let fixture: ComponentFixture<StaffOrderComponent>;
  let service: StaffOrderService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'staff-order', component: StaffOrderComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(StaffOrderComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.staffOrders?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
