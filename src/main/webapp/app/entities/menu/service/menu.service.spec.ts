...
describe('Menu Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      bookBeforeDate: currentDate,
      cancelBeforeDate: currentDate,
    };
  });
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          serveDate: currentDate.format(DATE_FORMAT),
          bookBeforeDate: currentDate.format(DATE_FORMAT),
          cancelBeforeDate: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
