...
@RestController
@RequestMapping("/api/ccms-kafka")
public class CcmsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CcmsKafkaResource.class);
    ...
    public CcmsKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
